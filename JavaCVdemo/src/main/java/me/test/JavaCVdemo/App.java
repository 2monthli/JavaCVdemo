...
public class App {
		...
		public static void main(String[] args) throws Exception {
	    	App app = new App();
	    	app.play("C:\\Users\\Public\\Videos\\Sample Videos\\陈政文-悲歌-(国语)[chedvd.com].avi");
	    }
...
class ComponentEventFacotry {
	 ...
	 * @param containner
	 */
	public void addComponentEventListener(Component component, int componentType, App containner) {
	 ...
	 * @param containner
	 */
	public void addMenuEventListener(MenuItem item, int componentType, App containner) {
		this.containner = containner;
		if (containner == null) {
			return;
		}
